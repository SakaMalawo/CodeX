<template>
  ...
  >
    ...
    <div class="flex w-full items-center justify-between md:hidden">
      ...
      <!-- Download + Notifications + Messages + Profil -->
      <div class="flex items-center gap-2">
        ...
        >
          <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" :class="{ 'text-gray-300': darkMode, 'text-gray-600': !darkMode }">
        ...
        <div class="relative">
          ...
          >
            <div class="py-1">
              ...
              <a href="#" class="block px-4 py-2 text-sm" :class="{ 'text-gray-300 hover:bg-gray-600': darkMode, 'text-gray-700 hover:bg-gray-100': !darkMode }">
              ...
              <button
                ...
                :class="{ 'text-gray-300 hover:bg-gray-600': darkMode, 'text-gray-700 hover:bg-gray-100': !darkMode }"
              >
